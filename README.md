...
Задай у Render → Environment змінну `PANEL_PASSWORD` — і браузер попросить пароль.
Логін будь-який, перевіряється тільки пароль. Без змінної панель відкрита, як і раніше.
